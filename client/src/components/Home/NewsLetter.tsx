    ...
    return (
        <section className='bg-white py-18 px-4 sm:px-6 lg:px-8 rounded-3xl mx-auto shadow-xs mt-32 mb-20'>
            <div className='max-w-2xl mx-auto text-center'>
                ...
                <form className='flex flex-col sm:flex-row gap-3 max-w-md mx-auto' onClick={(e) => e.preventDefault()}>
                    <input type='email' placeholder='Enter your email address' required className='flex-1 px-3 py-3.5 rounded-xl border border-app-border focus:border-app-green focus:ring bg-white text-sm transition-all' />
